...
# python mem_inf_stats.py --logdir="./logs/mimic-iv-ed/wrn_28_2" --dataset="mimic-iv-ed" --patient_level_only=$PATIENT_LEVEL_ONLY
# python mem_inf_stats.py --logdir="./logs/mimic-iv-ed/resnet_275_6" --dataset="mimic-iv-ed" --patient_level_only=$PATIENT_LEVEL_ONLY
# python mem_inf_stats.py --logdir="./logs/ptb-xl/resnet1d_28" --dataset="ptb-xl" --patient_level_only=$PATIENT_LEVEL_ONLY
