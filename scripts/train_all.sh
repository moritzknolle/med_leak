...
python chexpert.py --eval_only=False --n_runs=200 --model='vit_b_16' --logdir="./logs/chexpert/vit_b_16" --img_size=128
...
python fitzpatrick.py --eval_only=False --n_runs=200 --model='vit_b_16' --logdir="./logs/fitzpatrick/vit_b_16"
