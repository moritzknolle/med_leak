...
srun --output=slurm_out/%j-%x-%t.out bash scripts/run_until_error.sh python embed_dp.py \
    --eval_only=False \
    --n_runs=200 \
    ...
    --logdir="/dss/dssmcmlfs01/pn67bo/pn67bo-dss-0000/moritz/logs/embed/dp/epsinf_clip" \