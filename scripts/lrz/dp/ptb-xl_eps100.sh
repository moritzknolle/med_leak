...
#SBATCH --job-name=ptb-xl_dp_eps100
...
srun --output=slurm_out/%j-%x-%t.out bash scripts/run_until_error.sh python ptb-xl_dp.py \
    --eval_only=False \
    --n_runs=200 \
    --epsilon=100 \
    ...
    --logdir="/dss/dssmcmlfs01/pn67bo/pn67bo-dss-0000/moritz/logs/ptb-xl/dp/eps100" \